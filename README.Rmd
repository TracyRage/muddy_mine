...
[NCBI Taxonomy](ftp://ftp.ncbi.nlm.nih.gov/pub/taxonomy/) database (Nov, 2020). We built a local NCBI database with [ETE3](https://github.com/etetoolkit/ete) [@cepas_2016].
...
`python -c 'from ete3 import NCBITaxa; ncbi = NCBITaxa(); ncbi.update_taxonomy_database()'`
 ...
 If get an error, [click here](https://github.com/Prunoideae/MitoFlex/issues/2#issuecomment-682018016).
